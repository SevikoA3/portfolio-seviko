      ...
      <div className="max-w-5xl">
        ...
        <section className="group relative mb-6 border border-outline-variant/10 bg-surface-container-low p-5 sm:p-7 md:p-10">
          ...
          <div className="w-full font-mono">
            <div className="flex w-full items-center space-x-4 border border-outline-variant/5 bg-surface-container-highest/30 p-4 min-w-0">
        ...
        <section className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          <a href="https://www.instagram.com/sevikoarik_/" target="_blank" rel="noopener noreferrer" className="bg-surface-container-high p-6 md:p-7 flex flex-col items-center justify-center border border-outline-variant/5 hover:bg-surface-container-highest hover:border-primary/20 transition-colors group min-h-28">
          ...
          <a href="https://github.com/SevikoA3" target="_blank" rel="noopener noreferrer" className="bg-surface-container-high p-6 md:p-7 flex flex-col items-center justify-center border border-outline-variant/5 hover:bg-surface-container-highest hover:border-primary/20 transition-colors group min-h-28">
          ...
          <a href="https://www.linkedin.com/in/seviko/" target="_blank" rel="noopener noreferrer" className="bg-surface-container-high p-6 md:p-7 flex flex-col items-center justify-center border border-outline-variant/5 hover:bg-surface-container-highest hover:border-primary/20 transition-colors group min-h-28">
