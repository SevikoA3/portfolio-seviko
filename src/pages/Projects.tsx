                ...
                <div className="flex grow flex-col p-6 sm:p-7 font-body">
                  ...
                  <div className="mb-6 flex flex-wrap gap-2">
                    {project.tags.map((tag) => (
                      <span
                        key={tag}
                        className="glass-chip rounded-full border border-outline-variant/15 px-3 py-1 text-[10px] font-mono uppercase tracking-[0.14em] text-secondary"
                      >
                        {tag}
                      </span>
                    ))}
              ...
              <article className="glass-panel flex h-full flex-col rounded-[22px] border border-outline-variant/15 p-5 transition-all duration-300 hover:-translate-y-1 hover:border-secondary/35 hover:shadow-[0_20px_56px_rgba(7,10,24,0.18)]">
                ...
                <div className="mt-auto flex flex-wrap gap-2">
                  {project.tags.map((tag) => (
                    <span
                      key={tag}
                      className="glass-chip rounded-full border border-outline-variant/15 px-2.5 py-1 text-[9px] font-mono uppercase tracking-[0.12em] text-secondary"
                    >
                      {tag}
                    </span>
                  ))}
